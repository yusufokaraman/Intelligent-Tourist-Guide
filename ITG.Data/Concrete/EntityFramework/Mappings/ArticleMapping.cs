...
namespace ITG.Data.Concrete.EntityFramework.Mappings
{
    ...
    public class ArticleMapping : IEntityTypeConfiguration<Article>
    {
        public void Configure(EntityTypeBuilder<Article> builder)
        {
            ...
            builder.HasOne<City>(a => a.City).WithMany(c => c.Articles).HasForeignKey(a => a.CityId);
            builder.HasOne<Place>(a => a.Place).WithMany(c => c.Articles).HasForeignKey(a => a.PlaceId);
